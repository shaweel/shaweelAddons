...
class Utils {
	...
	drawCustomTitle(title, fadeIn, time, fadeOut, color) {
	...
	calculate3DDistanceFromPointAToPointBInTheShortestPossibleStraightLine(PointAX, PointAY, PointAZ, PointBX, PointBY, PointBZ) {
