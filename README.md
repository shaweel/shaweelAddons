...
## Features
Feature list is sizably outdated, the Features folder and the config.js file might prove more useful
...
## Installation
- This should work on every operating system, tested on: Windows, Linux(Arch Linux)
...
3. In Minecraft run the command */ct unload* ***THIS IS VERY IMPORTANT***
4. In Minecraft run the command */ct files*
5. Open the modules directory
6. Open the shaweelAddons directory
