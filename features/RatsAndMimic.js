...
register("entityDeath", (entity) => {
    ...
    if (utils.getDungeonFloor() != -1 && !Settings.mimicAnnounce && !Settings.mimicSound && !Settings.mimicTitle) return
    if (utils.getDungeonFloor() == -1 && !Settings.ratSound && !Settings.ratTitle)
